...
//    };
    ...
    jQuery.fn.clickEventDispatch = function(){
        var a = this[0];
        var evObj = document.createEvent('MouseEvents');
        evObj.initMouseEvent('click', true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, a);
    ...
    jQuery.fn.getPath = function () {
        ...
        while (node.length) {
            ...
            if (!name || name.toLowerCase() == '#document' || name.toLowerCase()== 'body' || name.toLowerCase()== 'html') break;

            name = name.toLowerCase();
            if (realNode.id) {
                // As soon as an id is found, there's no need to specify more.
                return name + '[id$="' + realNode.id +'"]'+ (path ? '>' + path : '');
